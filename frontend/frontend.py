    ...
    with gr.Blocks(css=css(opt), analytics_enabled=False, title="Stable Diffusion WebUI") as demo:
        with gr.Tabs(elem_id='tabss') as tabs:
            with gr.TabItem("Text-to-Image", id='txt2img_tab'):
                ...
                txt2img_btn.click(
                    txt2img,
                    [txt2img_prompt, txt2img_steps, txt2img_sampling, txt2img_toggles, txt2img_realesrgan_model_name, txt2img_ddim_eta, txt2img_batch_count, txt2img_batch_size, txt2img_cfg, txt2img_dynamic_threshold, txt2img_static_threshold, txt2img_seed, txt2img_variant_amount, txt2img_variant_seed, txt2img_height, txt2img_width, txt2img_embeddings],
